...
its DFR stays at the claimed order. No attack we describe is practical; the
results invalidate the stated security levels of DTRU in the DFR metric and
the methodology used to compute them.
\end{abstract}
...
\texttt{exact\_cgf\_check.py}, \texttt{recover.py})
